...
const AccommodationCard = ({accommodation, onEdit, onDelete}) => {
    ...
    if (!accommodation) {
        console.warn("Accommodation is undefined");
        return null; // или можеш да ставиш loading spinner тука
    }
        ...
        <>
            <Card sx={{boxShadow: 3, borderRadius: 2, p: 1}}>
                <CardContent>
                    ...
                    <Typography variant="h5">{accommodation.host?.name ?? "Unknown Host"}</Typography>
                    <Typography
                        variant="body1"
                        fontWeight="bold"
